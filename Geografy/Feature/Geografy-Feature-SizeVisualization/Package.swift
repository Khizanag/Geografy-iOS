...
let package = Package(
    name: "Geografy-Feature-SizeVisualization",
    platforms: [
        .iOS("26.0"),
        .tvOS("26.0"),
    ],
    products: [
        .library(
            name: "Geografy-Feature-SizeVisualization",
            targets: ["Geografy-Feature-SizeVisualization"]
        ),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .testTarget(
            name: "Geografy-Feature-SizeVisualizationTests",
            dependencies: ["Geografy-Feature-SizeVisualization"]
        ),
    ],
