...
let package = Package(
    name: "Geografy-Feature-EconomyExplorer",
    ...
    products: [
        .library(
            name: "Geografy-Feature-EconomyExplorer",
            targets: ["Geografy-Feature-EconomyExplorer"]
        ),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .testTarget(
            name: "Geografy-Feature-EconomyExplorerTests",
            dependencies: ["Geografy-Feature-EconomyExplorer"]
        ),
    ],
