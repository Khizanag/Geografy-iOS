...
let package = Package(
    name: "Geografy-Feature-IndependenceTimeline",
    ...
    products: [
        .library(
            name: "Geografy-Feature-IndependenceTimeline",
            targets: ["Geografy-Feature-IndependenceTimeline"]
        ),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .testTarget(
            name: "Geografy-Feature-IndependenceTimelineTests",
            dependencies: ["Geografy-Feature-IndependenceTimeline"]
        ),
    ],
