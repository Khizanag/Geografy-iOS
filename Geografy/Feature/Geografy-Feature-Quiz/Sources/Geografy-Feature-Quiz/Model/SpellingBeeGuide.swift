...
public enum SpellingBeeIllustration: Int, CaseIterable {
    case flagAndType
    case letterFeedback
    case hints
    case scoring
...
public enum SpellingBeeGuide {
    public static let pages: [GuidePage] = [
        GuidePage(
            title: "See the Flag, Type the Name",
            subtitle: "You'll see a country's flag and continent."
                + " Type the country name letter by letter — spelling matters!",
            steps: [
                GuideStep(
                    icon: "flag.fill",
        ...
        GuidePage(
            ...
            subtitle: "Each letter you type is checked instantly."
                + " Green means correct, red means wrong — fix it before moving on.",
            steps: [
                GuideStep(
