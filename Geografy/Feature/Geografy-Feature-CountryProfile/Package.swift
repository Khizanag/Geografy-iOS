...
let package = Package(
    name: "Geografy-Feature-CountryProfile",
    platforms: [
        .iOS("26.0"),
        .tvOS("26.0"),
    ],
    products: [
        .library(
            name: "Geografy-Feature-CountryProfile",
            targets: ["Geografy-Feature-CountryProfile"]
        ),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .testTarget(
            name: "Geografy-Feature-CountryProfileTests",
            dependencies: ["Geografy-Feature-CountryProfile"]
        ),
    ],
