...
let package = Package(
    name: "Geografy-Feature-LearningPath",
    ...
    products: [
        .library(
            name: "Geografy-Feature-LearningPath",
            targets: ["Geografy-Feature-LearningPath"]
        ),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .testTarget(
            name: "Geografy-Feature-LearningPathTests",
            dependencies: ["Geografy-Feature-LearningPath"]
        ),
    ],
