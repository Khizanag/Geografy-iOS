...
let package = Package(
    name: "Geografy-Feature-DistanceCalculator",
    ...
    products: [
        .library(
            name: "Geografy-Feature-DistanceCalculator",
            targets: ["Geografy-Feature-DistanceCalculator"]
        ),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .testTarget(
            name: "Geografy-Feature-DistanceCalculatorTests",
            dependencies: ["Geografy-Feature-DistanceCalculator"]
        ),
    ],
