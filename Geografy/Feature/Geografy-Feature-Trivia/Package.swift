...
let package = Package(
    ...
    products: [
        .library(
            name: "Geografy-Feature-Trivia",
            targets: ["Geografy-Feature-Trivia"]
        ),
    ],
    dependencies: [
        ...
        .package(path: "../../../Package/Geografy-Core-Quiz"),
    ...
    targets: [
        .target(
            ...
            dependencies: [
                ...
                .product(name: "Geografy-Core-Quiz", package: "Geografy-Core-Quiz"),
                .product(name: "Geografy-Core-Service", package: "Geografy-Core-Service"),
            ]
        ),
        .testTarget(
            name: "Geografy-Feature-TriviaTests",
            dependencies: ["Geografy-Feature-Trivia"]
        ),
    ],
