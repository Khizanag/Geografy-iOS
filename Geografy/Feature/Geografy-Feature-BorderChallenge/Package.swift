...
let package = Package(
    name: "Geografy-Feature-BorderChallenge",
    ...
    products: [
        .library(
            name: "Geografy-Feature-BorderChallenge",
            targets: ["Geografy-Feature-BorderChallenge"]
        ),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .testTarget(
            name: "Geografy-Feature-BorderChallengeTests",
            dependencies: ["Geografy-Feature-BorderChallenge"]
        ),
    ],
