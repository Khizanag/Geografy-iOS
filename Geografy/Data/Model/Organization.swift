...
extension Organization {
    ...
    private static let makeNATO = Organization(
        id: "NATO",
        displayName: "NATO",
    ...
    private static let makeEU = Organization(
        id: "EU",
        displayName: "EU",
    ...
    private static let makeASEAN = Organization(
        id: "ASEAN",
        displayName: "ASEAN",
    ...
    private static let makeAU = Organization(
        id: "AU",
    ...
    private static let makeArabLeague = Organization(
        id: "Arab League",
    ...
    private static let makeBRICS = Organization(
        id: "BRICS",
        displayName: "BRICS",
    ...
    private static let makeCIS = Organization(
        id: "CIS",
        displayName: "CIS",
    ...
    private static let makeCommonwealth = Organization(
        id: "Commonwealth",
    ...
    private static let makeG7 = Organization(
        id: "G7",
        displayName: "G7",
    ...
    private static let makeG20 = Organization(
        id: "G20",
        displayName: "G20",
    ...
    private static let makeMercosur = Organization(
        id: "Mercosur",
    ...
    private static let makeOECD = Organization(
        id: "OECD",
        displayName: "OECD",
    ...
    private static let makeOPEC = Organization(
        id: "OPEC",
        displayName: "OPEC",
    ...
    private static let makeSCO = Organization(
        id: "SCO",
        displayName: "SCO",
    ...
    private static let makeUSMCA = Organization(
        id: "USMCA",
        displayName: "USMCA",
    ...
    private static let makeWTO = Organization(
        id: "WTO",
        displayName: "WTO",
