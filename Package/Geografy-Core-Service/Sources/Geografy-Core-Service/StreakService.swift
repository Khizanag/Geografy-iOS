...
public final class StreakService {
    ...
    public private(set) var hasPlayedToday: Bool = false
    ...
    public init(db: DatabaseManager, xpService: XPService, achievementService: AchievementService, userID: String) {
        self.db = db
    ...
    public private(set) var weekActivityDates: Set<Date> = []
...
extension StreakService {
    ...
    public func loadWeekActivityDates(from records: [StreakRecord]) {
    ...
    public func computeConsecutiveDays(from records: [StreakRecord]) -> Int {
    ...
    public func updateProfileStreak() {
        let userID = currentUserID
