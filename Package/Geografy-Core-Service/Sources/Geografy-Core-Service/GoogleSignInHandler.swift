...
public struct GoogleUserInfo {
    ...
    public init(sub: String, email: String?, name: String?, givenName: String?, familyName: String?) {
        self.sub = sub
        self.email = email
        self.name = name
...
@MainActor
public final class GoogleSignInHandler: NSObject {
    /// Replace with your Google OAuth 2.0 Client ID from Google Cloud Console.
    /// Format: XXXXXXXXXX.apps.googleusercontent.com
    public static let clientID = "PLACEHOLDER_GOOGLE_CLIENT_ID.apps.googleusercontent.com"
    ...
    public func signIn() async throws -> GoogleUserInfo {
...
// MARK: - Error
public extension GoogleSignInHandler {
