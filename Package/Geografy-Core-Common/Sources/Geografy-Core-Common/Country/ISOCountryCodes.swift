...
public enum ISOCountryCodes: Sendable {
    public static func alpha2(from alpha3: String) -> String? {
        alpha3ToAlpha2[alpha3]
    }

    public static func alpha3(from alpha2: String) -> String? {
    ...
    private static let alpha3ToAlpha2: [String: String] = [
        ...
        "GHA": "GH", "GRC": "GR", "GRL": "GL", "GTM": "GT", "GIN": "GN",
